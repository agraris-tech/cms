...
export interface ApiCurrencyRateCurrencyRate
  ...
  attributes: {
    baseCurrency: Schema.Attribute.String;
    bynRate: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    kztRate: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rubRate: Schema.Attribute.Decimal;
    sourceName: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedAtExternal: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
}

export interface ApiEquipmentCardEquipmentCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'equipment_cards';
  info: {
    displayName: 'Equipment Card';
    pluralName: 'equipment-cards';
    singularName: 'equipment-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::equipment-card.equipment-card'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sortOrder: Schema.Attribute.Integer;
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authorName: Schema.Attribute.String & Schema.Attribute.DefaultTo<'AGRARIS'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    baseCurrency: Schema.Attribute.Enumeration<
      ['EUR', 'USD', 'BYN', 'RUB', 'KZT']
    >;
    brand: Schema.Attribute.Relation<'oneToOne', 'api::brand.brand'>;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    conditionLabel: Schema.Attribute.String;
    ...
    manufacturerAddress: Schema.Attribute.String;
    metaDescription: Schema.Attribute.Text;
    metaTitle: Schema.Attribute.String;
    power: Schema.Attribute.String;
    priceBase: Schema.Attribute.Decimal;
    priceFrom: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer;
    saleType: Schema.Attribute.Enumeration<['retail', 'wholesale', 'both']>;
    searchKeywords: Schema.Attribute.Text;
    ...
    supplierAddress: Schema.Attribute.String;
    ...
    wholesaleMinOrder: Schema.Attribute.Integer;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::equipment-card.equipment-card': ApiEquipmentCardEquipmentCard;
