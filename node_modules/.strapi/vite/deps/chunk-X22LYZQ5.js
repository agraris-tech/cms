...
var HistoryAction = ({ model, document }) => {
  ...
  return {
    icon: (0, import_jsx_runtime.jsx)(i5, {}),
    label: formatMessage({
...
var PreviewSidePanel = ({ model, documentId, document }) => {
  ...
  if (error && error.name === "NotFoundError") {
    return {
      title,
      content: (0, import_jsx_runtime2.jsx)(zn, {
        variant: "tertiary",
        tag: Link,
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-VBSYQZ6L.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-FIBYFAQQ.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-76BWJYEZ.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-76BWJYEZ.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-76BWJYEZ.js");
...
//# sourceMappingURL=chunk-X22LYZQ5.js.map
