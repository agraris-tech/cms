...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-K6ZUOPYW.js");
    case "./translations/es.json":
      return import("./es.json-7OP7FD3M.js");
    case "./translations/fr.json":
      return import("./fr.json-6DAW72D3.js");
    case "./translations/it.json":
      return import("./it.json-4QXP5AYJ.js");
    case "./translations/ru.json":
      return import("./ru.json-26ORRGEI.js");
    case "./translations/uk.json":
      return import("./uk.json-EPFGEZ43.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-LGYAMZ4Y.js");
          return App;
        }
      });
      const plugin = {
