import {
  useTypedSelector
} from "./chunk-JC472EXZ.js";
import {
  BulkActionsRenderer,
  TableActions
} from "./chunk-NAWGHR4M.js";
import {
  DocumentRBAC,
  InjectionZone,
  PERMISSIONS,
...
var Root = ({ disabled, schema, children }) => {
  var _a;
...
var LayoutsHeaderCustom = ut(Layouts.Header)`
...
var ListViewPage = () => {
  ...
  const displayedHeaders = React3.useMemo(() => {
    if (!displayedHeaderNames || !list.metadatas || Object.keys(list.metadatas).length <= 0 || !(schema == null ? void 0 : schema.attributes)) return [];
  ...
  const tableHeaders = React3.useMemo(() => {
    ...
    list,
    runHookWaterfall,
    (_c = schema == null ? void 0 : schema.options) == null ? void 0 : _c.draftAndPublish,
    model
  ]);
  if (isLoading) {
...
//# sourceMappingURL=ListViewPage-H2PUT3ZB.js.map
